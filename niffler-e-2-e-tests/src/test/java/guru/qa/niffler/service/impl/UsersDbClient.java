...
public class UsersDbClient implements UsersClient {
    ...
    public UserJson createUser(String username, String password) {
        System.out.println("Начало создания пользователя: " + username);
        try {
            return requireNonNull(xaTransactionTemplate.execute(() -> {
                System.out.println("Создаем auth пользователя: " + username);
                AuthUserEntity authUser = authUserEntity(username, password);
                authUserRepository.create(authUser);
                System.out.println("Auth пользователь создан: " + authUser);

                System.out.println("Создаем userdata пользователя: " + username);
                UserEntity userData = userdataUserRepository.create(userEntity(username));
                System.out.println("Userdata пользователя создан: " + userData);

                UserJson result = UserJson.fromEntity(userData, null);
                System.out.println("Пользователь успешно создан: " + result);
                return result;
            }));
        } catch (Exception e) {
            System.err.println("Ошибка при создании пользователя: " + username);
            e.printStackTrace();
            throw e;
        }
    }
